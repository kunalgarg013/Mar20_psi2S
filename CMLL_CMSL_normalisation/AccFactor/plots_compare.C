...
void compare_direct(TH1F* h1, TH1F* h2)
{
    ...
    h2->SetMarkerStyle(4);
    h2->GetYaxis()->SetRangeUser(0.75, 1.5);
    h2->Draw();
    h1->Draw("SAME");
...
void plots_compare()
{
    ...
    TH1F* hRBin1 = (TH1F*)fRoberta->Get("histoRaccMix_Cent0to10;1;1");
    TH1F* hRBin2 = (TH1F*)fRoberta->Get("histoRaccMix_Cent10to20;1;1");
    TH1F* hRBin3 = (TH1F*)fRoberta->Get("histoRaccMix_Cent20to30;1;1");
    TH1F* hRBin4 = (TH1F*)fRoberta->Get("histoRaccMix_Cent30to40;1;1");
    TH1F* hRBin5 = (TH1F*)fRoberta->Get("histoRaccMix_Cent40to50;1;1");
    TH1F* hRBin6 = (TH1F*)fRoberta->Get("histoRaccMix_Cent50to60;1;1");
    TH1F* hRBin7 = (TH1F*)fRoberta->Get("histoRaccMix_Cent60to70;1;1");
    TH1F* hRBin8 = (TH1F*)fRoberta->Get("histoRaccMix_Cent70to80;1;1");
