void compare_ratio(TH1F* h1, TH1F* h2)
{
    ...
    gPad->SaveAs(Form("Old_Ratios/%s.pdf", h1->GetName()));
}
...
void plots_compare()
{
    ...
    TH1F* hR_0to20 = (TH1F*)hRBin1->Clone("Cent_0to20");
    hR_0to20->Add(hRBin2);

    TH1F* hR_20to40 = (TH1F*)hRBin3->Clone("Cent_20to40");
    hR_20to40->Add(hRBin4);

    TH1F* hR_40to60 = (TH1F*)hRBin5->Clone("Cent_40to60");
    hR_40to60->Add(hRBin6);

    TH1F* hR_60to90 = (TH1F*)hRBin7->Clone("Cent_60to90");
    hR_60to90->Add(hRBin8);
    hR_60to90->Add(hRBin9);
   ...
   /* compare_direct(hKBin1, hRBin1);
    ...
    compare_ratio(hKBin1, hR_0to20);
    compare_ratio(hKBin2, hR_20to40);
    compare_ratio(hKBin3, hR_40to60);
    compare_ratio(hKBin4, hR_60to90);
