...
void Nplots_compare()
{
    ...
    TFile* fKunal = new TFile("MixEvSubtracted_OQR.root");
    TFile* fRoberta = new TFile("EvMixSub_CMLL_CMUL_Centrality.root");
    ...
    TH1F* hRBin1 = (TH1F*)fRoberta->Get("Cent_0to20;1");     //0 to 10
    TH1F* hRBin2 = (TH1F*)fRoberta->Get("Cent_20to40;1");     // 10 to 20
    TH1F* hRBin3 = (TH1F*)fRoberta->Get("Cent_40to60;1");     // 20 to 30
    TH1F* hRBin4 = (TH1F*)fRoberta->Get("Cent_60to90;1");     // 30 to 40
    TH1F* hRBin5 = (TH1F*)fRoberta->Get("Cent_0to90;1");     // 40 to 50
