...
void subMixing()
{
    ...
    Double_t NormFactor[10] = {0.428487, 0.569022, 0.43681, 0.31677, 0.216021, 0.135742, 0.0777926, 0.0404034, 0.0180295, 0.00566868};   //Ignore first value of the array.
    ...
    TFile* fTest = new TFile("Subtracted_18qr.root", "RECREATE");
