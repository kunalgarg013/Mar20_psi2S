...
void subMixing()
{
    ...
    TFile *f1 = new TFile("CMLL_oqr_AnalysisResults.root");//ok
    TObjArray *arr =(TObjArray*)f1->Get("ListEvent");

    TFile* f2                       = new TFile("mixed_oqr_24Nov.root");
    ...
    Double_t NormFactor[10] = {0.272417, 0.360274, 0.277633, 0.202092, 0.137532, 0.0865217, 0.049875, 0.0263832, 0.0121269, 0.00483608};   //Ignore first value of the array. Corresponds to 0-90 bin
    ...
    TFile* fTest = new TFile("Subtracted_oqr_24Nov.root", "RECREATE");
