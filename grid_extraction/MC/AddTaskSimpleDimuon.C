...
TaskCharmoniaDimuonMC* AddTaskSimpleDimuon()
{
  ...
  TaskCharmoniaDimuonMC *mainTask = new TaskCharmoniaDimuonMC("TaskCharmoniaDimuonMC",244900, 298000);
  if (!mainTask) {
    Error("AddTaskSimpleDimuon", "TaskCharmoniaDimuonMC task cannot be created!");
    return NULL;
  }
