...
void JpsiFitFunctions::DefineFunctions(RooRealVar *variable) {
  ...
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
   ...
   //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
  RooRealVar *CP0 = new RooRealVar("CP0", "CP0", 3, -100, 100);
  RooRealVar *CP1 = new RooRealVar("CP1", "CP1", 1, -100, 100);
  CebPol2 *bkgdCebPol2Function =
      new CebPol2("bkgdCebPol2Function", "bkgdCebPol2Function", *variable, *CP0,
                  *CP1);
  fListOfFunctions->AddAt(bkgdCebPol2Function, kCebPol2);
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//

//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
  RooRealVar *CP30 = new RooRealVar("CP30", "CP30", 3, -100, 100);
  RooRealVar *CP31 = new RooRealVar("CP31", "CP31", 1., -100, 100);
  CebPol3 *bkgdCebPol3Function =
      new CebPol3("bkgdCebPol3Function", "bkgdCebPol3Function", *variable, *CP30,
                  *CP31);
  fListOfFunctions->AddAt(bkgdCebPol3Function, kCebPol3);
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//

  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
  RooRealVar *SCP0 = new RooRealVar("SCP0", "SCP0", 30, -100, 100);
  RooRealVar *SCP1 = new RooRealVar("SCP1", "SCP1", 0.9, -100, 100);
  SpPol2 *bkgdSpPol2Function =
      new SpPol2("bkgdSpPol2Function", "bkgdSpPol2Function", *variable, *SCP0,
                  *SCP1);
  fListOfFunctions->AddAt(bkgdSpPol2Function, kSpPol2);
  //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++//
