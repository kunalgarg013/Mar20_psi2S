...
TString PrintEffi2(TString title, TH1 *histoAccEffi){
...
//-------------------------------------------------------------------------------------------------------------------------------------//
void GetAccEffi(Int_t iteration = 3)
{

  //-------------------------------------------------------------------------------------------------------------------------------------//
  Double_t arrayRapidityBins[][2] = {{-4, -3.5}, {-3.5, -3.25}, {-3.25, -3.}, {-3, -2.75}, {-2.75, -2.5}, {-4, -2.5}};
  ...
  Double_t arrayCentBins[][2] = {{0, 90}, {0, 10}, {10, 20}, {20, 40}, {40, 60}, {60, 90}};
  // Double_t arrayCentBins[][2] = {{0, 90}};
  ...
  TFile *fileCMULData = new TFile("../outputEvent.root");
  ...
  TTree *tree = ((TTree *)fileAnalysed->Get("eventsTree"));
  ...
  PrintEffi2("Acc*Effi Vs Pt", histoAccEffiVsPt);
  ...
  PrintEffi2("Acc*Effi Vs y", histoAccEffiVsRap);
  ...
  PrintEffi2("Acc*Effi Vs centrality", histoAccEffiVsCent);
  //-------------------------------------------------------------------------------------------------------------------------------------//
