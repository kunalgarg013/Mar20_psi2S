void subMixing()
{
    ...
    TFile* f2                       = new TFile("cent_rob_comp.root");
    ...
    Double_t NormFactor[10] = {0.150752, 0.199215, 0.153367, 0.111676, 0.0755088, 0.0474147, 0.0273089, 0.0145556, 0.0061637, 0.0021759};   //Ignore first value of the array.
