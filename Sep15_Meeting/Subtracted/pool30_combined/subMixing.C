...
void subMixing()
{
    ...
    TFile* f2                       = new TFile("pool30_mixed.root");
    ...
    Double_t NormFactor[10] = {0.178521, 0.236061, 0.181902, 0.132437, 0.090144, 0.0567205, 0.0326955, 0.0173245, 0.0079775, 0.00320841};   //Ignore first value of the array.
