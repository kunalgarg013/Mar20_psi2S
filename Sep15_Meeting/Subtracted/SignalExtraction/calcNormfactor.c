...
void calcNormfactor()
{
    ...
    TH1F* hMixedPlike[10];
    hMixedPlike[1] = (TH1F*)InvMassPlike->Get("histoInvMass_Cent0to20_Pt0to12;1");
    hMixedPlike[2] = (TH1F*)InvMassPlike->Get("histoInvMass_Cent20to40_Pt0to12;1");
    hMixedPlike[3] = (TH1F*)InvMassPlike->Get("histoInvMass_Cent40to60_Pt0to12;1");
    hMixedPlike[4] = (TH1F*)InvMassPlike->Get("histoInvMass_Cent60to90_Pt0to12;1");
    ...
    TH1F* hMixedNlike[10];
    hMixedNlike[1] = (TH1F*)InvMassNlike->Get("histoInvMass_Cent0to20_Pt0to12;1");
    hMixedNlike[2] = (TH1F*)InvMassNlike->Get("histoInvMass_Cent20to40_Pt0to12;1");
    hMixedNlike[3] = (TH1F*)InvMassNlike->Get("histoInvMass_Cent40to60_Pt0to12;1");
    hMixedNlike[4] = (TH1F*)InvMassNlike->Get("histoInvMass_Cent60to90_Pt0to12;1");
