...
void subMixing()
{
    ...
    TFile *f1 = new TFile("../../CMLL/CMLL_2015_AnalysisResults.root");//ok
    TObjArray *arr =(TObjArray*)f1->Get("ListEvent");

    TFile* f2                       = new TFile("../../CMSL/15o_cmsl.root");
    ...
    Double_t NormFactor[10] = {0.146761, 0.193924, 0.14933, 0.108729, 0.0735069, 0.0461619, 0.0265933, 0.0141498, 0.00599114, 0.00209913};   //Ignore first value of the array.
    ...
    TFile* fTest = new TFile("Subtracted_15o.root", "RECREATE");
