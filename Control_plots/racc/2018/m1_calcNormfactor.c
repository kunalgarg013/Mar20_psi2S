...
void m1_calcNormfactor()
{
    ...
    ofstream datnorm("norm_factor_m1_2018.dat");
    ...
    TFile* f2                       = new TFile("cmsl_2018_cent10width.root");
    ...
    for(Int_t l=0; l<10; l++)
    {
        ...
        int minMassBin1 = hRaw[l]->FindBin(2);
        int maxMassBin1 = hRaw[l]->FindBin(2.5);

        int minMassBin2 = hRaw[l]->FindBin(4);
        int maxMassBin2 = hRaw[l]->FindBin(5);
       ...
       NormFactor[l] = (hRaw[l]->Integral(minMassBin1, maxMassBin1)+ hRaw[l]->Integral(minMassBin2, maxMassBin2))/(hMixed[l]->Integral(minMassBin1, maxMassBin1) + hMixed[l]->Integral(minMassBin2, maxMassBin2));
