...
void m3_calcNormfactor()
{
    ...
    ofstream datnorm("norm_factor__m3_2018.dat");
    ...
    for(Int_t l=0; l<10; l++)
    {
        ...
        hMixedPlike[l]->Multiply((TH1F*)hRFactor[l]);
        ...
        NormFactor[l] = hRawPlusPlus[l]->Integral(minMassBin, maxMassBin)/(hMixedPlike[l]->Integral(minMassBin, maxMassBin));
