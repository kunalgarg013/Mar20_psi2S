...
void subMixing()
{
    ...
    TFile* f2                       = new TFile("Sig25MeV_15o.root");
    ...
    Double_t NormFactor[10] = {0.134712, 0.178025, 0.137014, 0.0998525, 0.0674643, 0.0424527, 0.024451, 0.0131957, 0.00573372, 0.00250122};
    ...
    TFile* fTest = new TFile("Subtracted_15o_25MeV.root", "RECREATE");
