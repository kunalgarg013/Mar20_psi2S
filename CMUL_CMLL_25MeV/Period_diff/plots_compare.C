...
void plots_compare()
{
    ...
    TFile* fRoberta = new TFile("MixEvSubtracted_sep_OQR_25MeV.root");
    ...
    TH1F* hRBin1 = (TH1F*)fRobertaNew->Get("Roberta_Cent_0to20;1");
    TH1F* hRBin2 = (TH1F*)fRobertaNew->Get("Roberta_Cent_20to40");
    TH1F* hRBin3 = (TH1F*)fRobertaNew->Get("Roberta_Cent_40to60");
    TH1F* hRBin4 = (TH1F*)fRobertaNew->Get("Roberta_Cent_60to90");
    TH1F* hRBin5 = (TH1F*)fRobertaNew->Get("Roberta_Cent_0to90");
