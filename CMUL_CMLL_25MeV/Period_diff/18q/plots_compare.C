void compare_ratio(TH1F* h1, TH1F* h2)
{
    ...
    gPad->SaveAs(Form("Ratios_Subtracted_18q/%s.pdf", h1->GetName()));
}
...
void plots_compare()
{
    ...
    TFile* fRoberta = new TFile("ExtendedAxis_18q.root");
    TFile* fRobertaNew = new TFile("EvMix_LHC18q_shared.root");
