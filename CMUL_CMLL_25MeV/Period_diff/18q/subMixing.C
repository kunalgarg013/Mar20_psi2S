...
void subMixing()
{
    ...
    Double_t NormFactor[10] = {0.343839, 0.456974, 0.349982, 0.253444, 0.172815, 0.108857, 0.0616111, 0.0326221, 0.0157217, 0.00400464};
    ...
    TFile* fTest = new TFile("Subtracted_18q_25MeV.root", "RECREATE");
