...
void subMixing()
{
    ...
    TFile* f2                       = new TFile("Sig25MeV_18r.root");
    ...
    Double_t NormFactor[10] = {0.529051, 0.702374, 0.540001, 0.392004, 0.26713, 0.167425, 0.0968259, 0.0506581, 0.021941, 0.00769471};
    ...
    TFile* fTest = new TFile("Subtracted_18r_25MeV.root", "RECREATE");
