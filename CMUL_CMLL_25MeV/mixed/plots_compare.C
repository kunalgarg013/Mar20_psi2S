...
void plots_compare()
{
    ...
    TFile* fRoberta = new TFile("ExtendedAxis_mixed_25MeV.root");
    TFile* fRobertaNew = new TFile("EvMix_LHCoqr_shared.root");
    ...
    TH1F* hRBin1 = (TH1F*)fRobertaNew->Get("hMassOS_Mix_CentrBin0;1");
    TH1F* hRBin2 = (TH1F*)fRobertaNew->Get("hMassOS_Mix_CentrBin1;1");
    TH1F* hRBin3 = (TH1F*)fRobertaNew->Get("hMassOS_Mix_CentrBin2;1");
    TH1F* hRBin4 = (TH1F*)fRobertaNew->Get("hMassOS_Mix_CentrBin3;1");
    TH1F* hRBin5 = (TH1F*)fRobertaNew->Get("hMassOS_Mix_CentrBin4;1");
    TH1F* hRBin6 = (TH1F*)fRobertaNew->Get("hMassOS_Mix_CentrBin5;1");
    TH1F* hRBin7 = (TH1F*)fRobertaNew->Get("hMassOS_Mix_CentrBin6;1");
    TH1F* hRBin8 = (TH1F*)fRobertaNew->Get("hMassOS_Mix_CentrBin7;1");
    TH1F* hRBin9 = (TH1F*)fRobertaNew->Get("hMassOS_Mix_CentrBin8;1");
