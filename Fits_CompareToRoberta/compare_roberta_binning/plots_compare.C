void compare_ratio(TH1F* h1, TH1F* h2)
{
    ...
    legend1->AddEntry(h2,"Roberta Old/New of 10","p");
...
void plots_compare()
{
    ...
    TFile* fRoberta = new TFile("MixEvSubtracted_OQR_Roberta24Nov.root");
    TFile* fRobertaNew = new TFile("fRobHistoEvMix.root");

    TH1F* hKBin1 = (TH1F*)fRoberta->Get("Cent_0to20");
    TH1F* hKBin2 = (TH1F*)fRoberta->Get("Cent_20to40");
    TH1F* hKBin3 = (TH1F*)fRoberta->Get("Cent_40to60");
    TH1F* hKBin4 = (TH1F*)fRoberta->Get("Cent_60to90");
    TH1F* hKBin5 = (TH1F*)fRoberta->Get("Cent_0to90");

    TH1F* hKNBin1 = (TH1F*)fRobertaNew->Get("Roberta_Cent_0to20;1");
    TH1F* hKNBin2 = (TH1F*)fRobertaNew->Get("Roberta_Cent_20to40");
    TH1F* hKNBin3 = (TH1F*)fRobertaNew->Get("Roberta_Cent_40to60");
    TH1F* hKNBin4 = (TH1F*)fRobertaNew->Get("Roberta_Cent_60to90");
    TH1F* hKNBin5 = (TH1F*)fRobertaNew->Get("Roberta_Cent_0to90");
